    ...
    <>
      <section id="about">
        <div className="container mx-auto flex py-20 md:flex-row flex-col items-center mt-5">
          <div className="lg:flex-grow mx-2 md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font text-4xl mb-4 font-medium text-white mt-5">
